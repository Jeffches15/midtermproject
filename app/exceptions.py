...
# The exceptions module defines custom exception classes—like ValidationError, OperationError, 
# and so on—which are then imported and used by other parts of your application, 
# such as the InputValidator class.
